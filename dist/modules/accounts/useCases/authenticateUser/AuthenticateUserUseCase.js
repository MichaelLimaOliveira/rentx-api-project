...
let AuthenticateUserUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  return (0, _tsyringe.inject)("IUsersTokensRepository")(target, undefined, 1);
  ...
  async execute({
    ...
    if (!user) throw new _AppError.AppError("Email or password incorrect!");
    const passwordMatch = await (0, _bcrypt.compare)(password, user.password);
    if (!passwordMatch) throw new _AppError.AppError("Email or password incorrect!");
