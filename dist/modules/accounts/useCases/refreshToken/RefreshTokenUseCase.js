...
let RefreshTokenUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  return (0, _tsyringe.inject)("IUsersTokensRepository")(target, undefined, 0);
}, _dec3 = function (target, key) {
  return (0, _tsyringe.inject)("IDateProvider")(target, undefined, 1);
  ...
  async execute(token) {
    ...
    const user_id = sub;
    const userToken = await this.usersTokensRepository.findByUsersIdAndRefreshToken(user_id, token);
    if (!userToken) {
